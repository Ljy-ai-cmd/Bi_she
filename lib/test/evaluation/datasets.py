...
dataset_dict = dict(
    ...
    antiuav_rgb=DatasetInfo(module=pt % "antiuav", class_name="AntiUAVDataset", kwargs=dict(modality='rgb')),
    antiuav_ir=DatasetInfo(module=pt % "antiuav", class_name="AntiUAVDataset", kwargs=dict(modality='ir')),
    antiuav_all=DatasetInfo(module=pt % "antiuav", class_name="AntiUAVDataset", kwargs=dict(modality='all')),
)
