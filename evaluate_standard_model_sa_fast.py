#!/usr/bin/env python3
"""
SUTrack Standard Model Evaluation Script with SA Algorithm (Fast Version)
在Anti-UAV测试集上评估模型性能（红外模态）- 优化版本
...
def main():
    """主函数 - 优化版本"""
    MODEL_PATH = r'E:\biyesheji\SUTrack-main11\output\b224_antiuav_standard\checkpoints\train\sutrack\sutrack_b224_antiuav_standard\SUTRACK_ep0180.pth.tar'
    CONFIG_NAME = 'sutrack_b224_antiuav_standard'
    TEST_DIR = r'E:\biyesheji\SUTrack-main11\data\AntI-UAV\test'
    
    print("="*60)
    print("SUTrack Standard Model Evaluation (Infrared + SA Algorithm)")
    print("Fast Version - Optimized with NumPy Vectorization")
    print("="*60)
    ...
    if total_sa:
        ...
        print("\n" + "="*60)
        print("Evaluation Results - Infrared Modality with SA Algorithm")
        print("="*60)
        ...
        output_file = 'evaluation_results_standard_sa_infrared_fast.json'
